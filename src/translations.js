const translations = {
  ...
  selectPriority: ['Select the priority', 'Seleccione la prioridad', 'Выберите приоритет'],
  ...
  uncompleteTasks: ['Uncomplete tasks', 'No completar las tareas', 'Не выполнить задачи'],
  ...
  setNotification: ['Set notification', 'Establecer notificación', 'Задать уведомление'],
