const translations = {
  ...
  allCompletedDeleted: [
    ...
    'Se eliminaron todas las tareas completadas',
  ...
  autoClose: [
    ...
    'Autocerrar después de guardar',
    'Автозакрытие после сохранения',
  ],
  ...
  selectValue: ['Select value', 'Seleccionar valor', 'Выберите значение'],
  ...
  selectedCompleted: [
    ...
    'Tareas seleccionadas completadas',
    'Выбранные задачи выполнены',
  ],
  selectedDeleted: [
    'Selected tasks deleted',
    'Tareas seleccionadas eliminadas',
  ...
  notificated: [
    'Only with notificated',
    'Solo con notificado',
    'Только с уведомлением',
  ],
  emptyList: [
    'List is empty yet',
    'La lista aún está vacía',
    'Список пока пуст',
  ],
  tasksNotFound: [
    'Tasks not found',
